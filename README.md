...
PLR group operations for chord transformations - Parallel-Lead-Relative group acting on major/minor triads
...
```bash
git clone https://github.com/SuperInstance/harmonic-plr-rs
cd harmonic-plr-rs
```
